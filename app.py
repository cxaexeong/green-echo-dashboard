    ...
    if find_target.empty:
        ...
        def make_current_dashboard():
            fig = make_subplots(
                ...
                row_heights=[0.51, 0.08, 0.23, 0.19],
            ...
            fig.add_annotation(xref="x domain", yref="y domain", x=right_x, y=top_y, text="<b>우수형</b><br><span style='font-size:11px; color:black'>(구매율 높음, 구매액 높음)</span>", showarrow=False, align="center", font=dict(size=16, color="rgba(46, 204, 113, 0.85)"))
            fig.add_annotation(xref="x domain", yref="y domain", x=left_x, y=top_y, text="<b>성과유지형</b><br><span style='font-size:11px; color:black'>(구매율 높음, 구매액 유지 또는 낮음)</span>", showarrow=False, align="center", font=dict(size=16, color="rgba(212, 172, 13, 0.90)"))
            fig.add_annotation(xref="x domain", yref="y domain", x=left_x, y=bottom_y, text="<b>개선필요형</b><br><span style='font-size:11px; color:black'>(구매율 낮음, 구매액 낮음)</span>", showarrow=False, align="center", font=dict(size=16, color="rgba(231, 76, 60, 0.85)"))
            fig.add_annotation(xref="x domain", yref="y domain", x=right_x, y=bottom_y, text="<b>잠재성장형</b><br><span style='font-size:11px; color:black'>(구매율 낮음, 구매액 높음)</span>", showarrow=False, align="center", font=dict(size=16, color="rgba(52, 152, 219, 0.85)"))
