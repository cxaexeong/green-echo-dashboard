...
if search_name:
    ...
    if find_target.empty:
        ...
        def make_current_dashboard():
            ...
            fig.add_annotation(xref="x1", yref="y1", x=np.log10(ai_amount_line), y=vertical_line_y1 - (y_range[1] - y_range[0]) * 0.15, text=amount_label, textangle=-90, showarrow=False, font=dict(size=11, color="black"), xanchor="center", xshift=15, yanchor="top")
